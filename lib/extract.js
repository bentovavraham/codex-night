...
// matchProject: check filename + extracted clues against a project and its aliases.
// allProjects: array of { name, keywords } for ALL projects (used to detect mismatches).
function matchProject(projectClues, projectName, projectAliases = [], filename = '', allProjects = []) {
  ...
  // Helper: does this text match any keyword/word in the name list?
  ...
  // Check if it clearly matches a DIFFERENT known project → mismatch
